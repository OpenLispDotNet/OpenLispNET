...
namespace OpenLisp.Core.StaticClasses.Funcs
{
    ...
    public class StringFuncs
    {
        ...
        /// </summary>
        public static readonly OpenLispFunc PrStr = new OpenLispFunc(x =>
        ...
        /// in the context of an <see cref="OpenLispFunc"/>.
        /// </summary>
        public static readonly OpenLispFunc Str = new OpenLispFunc(x => 
        ...
        /// </summary>
        public static readonly OpenLispFunc Prn = new OpenLispFunc(x =>
        {
        ...
        /// an <see cref="OpenLispFunc"/>; like returning void in C#, etc.
        /// </summary>
        public static readonly OpenLispFunc PrintLn = new OpenLispFunc(x =>
        {
        ...
        /// in the context of an <see cref="OpenLispFunc"/>.
        /// </summary>
        public static readonly OpenLispFunc OpenLispReadLine = new OpenLispFunc(x =>
        {
        ...
        /// </summary>
        public static readonly OpenLispFunc ReadString = new OpenLispFunc(x =>
        ...
        /// </summary>
        public static readonly OpenLispFunc Slurp = new OpenLispFunc(x =>
